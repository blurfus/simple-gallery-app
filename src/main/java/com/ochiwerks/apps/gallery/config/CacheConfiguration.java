package com.ochiwerks.apps.gallery.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ochiwerks.apps.gallery.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ochiwerks.apps.gallery.repository.UserRepository.USERS_BY_EMAIL_CACHE);
