...
import com.ochiwerks.apps.gallery.domain.Author;
import com.ochiwerks.apps.gallery.service.AuthorService;
...
/**
 * REST controller for managing {@link com.ochiwerks.apps.gallery.domain.Author}.
 */
@RestController
@RequestMapping("/api")
